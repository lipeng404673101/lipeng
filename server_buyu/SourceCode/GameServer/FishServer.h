...
private:
	...
	//减少金币
	bool	ChangeGlobeContrlDown(DWORD ChangeGlobe, bool IsSendToClient = true, bool IsSaveToDB = false, bool IsSendToMiniGame = false, DWORD dwDaiLiUserID = 0, bool bIsCanContrl = false, bool bIsZongDai = true);
