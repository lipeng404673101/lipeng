...
void FishServer::OnTcpServerLeave(BYTE ServerID, ServerClientData* pClient)
{
	...
	{
		LogInfoToFile("Control.txt", "OnTcpServerLeave一个外部客户端离开了控制器 %d", ServerID);
		//一个控制器离开了
...
void FishServer::OnTcpServerJoin(BYTE ServerID, ServerClientData* pClient)
{
	...
	{
		LogInfoToFile("Control.txt", "OnTcpServerJoin一个外部服务器加入控制器 %d", ServerID);
		//一个管理器加入了
...
void FishServer::HandleClientMsg(ServerClientData* pClient, NetCmd* pCmd)
{
	...
	/*LogInfoToFile("Control.txt", "HandleClientMsg函数进入 %s", pData);*/
	//////////////////////////////////////////////////////////////////////////
	...
	LogInfoToFile("Control.txt", "HandleClientMsg函数进入控制消息 :::%d***********", pCmd->SubCmdType);
...
void FishServer::HandleServerMsg(ServerClientData* pClient, NetCmd* pCmd)
{
	...
	{
							  LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_KickUserResult服务消息 %d*************", pCmd->SubCmdType);
	...
	{
								LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_HandleEntityItem服务消息 %d**************", pCmd->SubCmdType);
	...
	{
								  // LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_QueryOnlineUserInfo服务消息 %d", pCmd->SubCmdType);
	...
	{
									  LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_ChangeParticularStates服务消息 %d", pCmd->SubCmdType);
	...
	{
								   LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_QueryFishPoolResult服务消息 %d", pCmd->SubCmdType);
	...
	{
									LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_QueryBlackListResult服务消息 %d", pCmd->SubCmdType);
	...
	{
								  LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_SetBlackListResult服务消息 %d", pCmd->SubCmdType);
	...
	case LC_OxAdmin:
	{
					   LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_OxAdmin服务消息 %d", pCmd->SubCmdType);
	...
	{
								LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_OxAdminQueryName服务消息 %d", pCmd->SubCmdType);
	...
	{
									 LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_OxAdminQueryAllJetton服务消息 %d", pCmd->SubCmdType);
	...
	{
										LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_OxAdminQueryPlayerJetton服务消息 %d", pCmd->SubCmdType);
	...
	case LC_AnimalAdmin:
	{
						   LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_AnimalAdmin服务消息 %d", pCmd->SubCmdType);
	...
	{
									LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_AnimalAdminQueryName服务消息 %d", pCmd->SubCmdType);
	...
	{
										 LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_AnimalAdminQueryAllJetton服务消息 %d", pCmd->SubCmdType);
	...
	{
											LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_AnimalAdminQueryPlayerJetton服务消息 %d", pCmd->SubCmdType);
	...
	case LC_CarAdmin:
	{
						LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_CarAdmin服务消息 %d", pCmd->SubCmdType);
	...
	{
								 LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_CarAdminQueryName服务消息 %d", pCmd->SubCmdType);
	...
	{
									  LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_CarAdminQueryAllJetton服务消息 %d", pCmd->SubCmdType);
	...
	{
										 LogInfoToFile("Control.txt", "11111111111HandleServerMsg控制消息LC_CarAdminQueryPlayerJetton服务消息 %d", pCmd->SubCmdType);
