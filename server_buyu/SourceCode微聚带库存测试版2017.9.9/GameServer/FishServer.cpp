	...
	case LG_AccountOnlyID:
		{
			...
			//DBR_Cmd_AccountHeadHttp msg;
			//SetMsgInfo(msg, DBR_AccountHeadHttp, sizeof(DBR_Cmd_AccountHeadHttp));
			//msg.ClientID = pClient->OutsideExtraData;
			//msg.dwUserID = dwUserID;
			//TCHARCopy(msg.szHeadHttp, CountArray(msg.szHeadHttp), pMsg->szHeadHttp, _tcslen(pMsg->szHeadHttp));//修改头像  xuyao 需要客户端传入头像
			//SendNetCmdToDB(&msg);
			//////////////////////////////////////////////////////////////////////////////
	...
	case CL_RoleBetGlobel:
		{
			...
			//1.先扣除玩家的金币  先扣除抽水
			if (!pRole->ChangeRoleGlobe((pMsg->AddGlobel + pMsg->AddGlobel*5/1000)*-1, true))
			{
				ASSERT(false);
				return false;
			}
