...
public:
	...
	//私有桌子号码
	virtual int& GetPrivateTableID() { return m_sPrivateTableID; }

	void SetPrivateTableOwnerID(DWORD dwUserID){ m_wPrivateTableOwnerID = dwUserID; }
	DWORD GetPrivateTableOwnerID(){ return m_wPrivateTableOwnerID; }
...
public:	// xiugai 修改
	...
	int							m_sPrivateTableID;					//私有桌子号

	DWORD							m_wPrivateTableOwnerID;				//创建者ID(决定解散权限，主要用于vip)
