...
void BindPhoneManager::OnGetPhoneVerificationNumberResult(bool Result, BYTE ErrorID, DWORD dwUserID/*,unsigned __int64  PhoneNumber*/)
{
...
bool BindPhoneManager::OnBindPhontByVerificationNumber(ServerClientData* pClient, GO_Cmd_BindPhone* pMsg)
{
	...
	//OG_Cmd_GetPhoneVerificationNum msg1;
	////SetMsgInfo(msg, GetMsgType(Main_Operate, OG_GetPhoneVerificationNum), sizeof(OG_Cmd_GetPhoneVerificationNum));
	//msg1.dwUserID = pMsg->dwUserID;
	//msg1.ErrorID = ROE_PhoneVerificationNum_Sucess;
	//msg1.PhoneNumber = pMsg->BindNumber;
	//g_FishServer.SendNetCmdToClient(pClient, &msg1);
