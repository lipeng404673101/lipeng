...
private:
	...
	//头像
	bool OnHandleAccountHeadHttp(BYTE Index, BYTE ClientID, NetCmd* pCmd);//微信头像
	...
	bool OnHandleSaveRoleGlobelDown(BYTE Index, BYTE ClientID, NetCmd* pCmd);


	bool OnHandleCheckUserDaili(BYTE Index, BYTE ClientID, NetCmd* pCmd);
	//tianji添加赠送检测
	bool OnHandleCheckUserContrlDaili(BYTE Index, BYTE ClientID, NetCmd* pCmd);
	//////////////////////////////////////////////////////////////////////////
	//	检查			代理绑定
	bool OnHandleCheckDailiBond(BYTE Index, BYTE ClientID, NetCmd* pCmd);
	//代理绑定
	bool OnHandleDailiBond(BYTE Index, BYTE ClientID, NetCmd* pCmd);

	//房间申请   房卡模式   房间号 
	bool OnHandleCreatePrivateRoom(BYTE Index, BYTE ClientID, NetCmd* pCmd);
	//删除房间
	bool OnHandleDeletePrivateRoom(BYTE Index, BYTE ClientID, NetCmd* pCmd);
	//////////////////////////////////////////////////////////////////////////
