...
struct tagRoleInfo
{
	...
	//新添的参数  为了让金币更新同步而添加的   
//	__int64			bChangeScore;//变化的金币   __int64  jiu就是LONG  longlong
...
//请求信息
struct CL_Cmd_QRoleDaili : public NetCmd
{
	DWORD		dwUserID;
	//int			dwGlobeNum;//充值数量
	//bool		bIsSuccess;//是否成功
...
//代理信息
struct LC_Cmd_GetRoleDaili : public NetCmd
{
...
{
	BYTE TableID;//桌子的id 0 1 2 3 
	double nValue;//修改的库存值
