...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	void		QueryNames(DWORD ClientID, DWORD	ContrlUserID);
	void		QueryAllJetton(DWORD ClientID, DWORD	ContrlUserID);

	void		QueryPlayerJetton(DWORD dwUserID, DWORD ClientID, DWORD	ContrlUserID);//修改原来的函数
...
private:
	...
	//添加区域下注总量  包含机器人
	UINT64						m_TableBetAreaGlobelAllUser[MAX_DIAL_ClientSum];//12个下注区的金币总数
};